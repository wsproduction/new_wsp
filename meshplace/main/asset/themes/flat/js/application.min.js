...
function getSidebarScrollHeight() {
    ...
    if (n.hasClass("navbar-fixed-top") && t.scrollTop() == 0 || t.scrollTop() == 0)
        r -= 40;
...
function checkLeftNav() {
    ...
    if (e.width() <= 840) {
        ...
        if (e.width() < 1200) {
            ...
            $("body").hasClass("forced-fluid") && versionFixed()
    }
}
...
$(document).ready(function() {
    ...
    $(".content-remove").click(function(e) {
        ...
        if (i.length > 0)
            var s = parseInt(i.attr("class").replace("span", ""));
        bootbox.animate(!1);
...
$(window).scroll(function(e) {
    ...
    if (n.scrollTop() == 0 || $("#left").hasClass("sidebar-fixed"))
