                ...
                <div class="container-fluid">
                    ...
                    <ul class='main-nav'>
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu">
                                <li class='dropdown-submenu'>
                                    <a href="forms-basic.html">Master Data Akademik &nbsp;  &nbsp; </a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="more-shop-list.html">Tahun Pelajaran</a>
                                        </li>
                                        <li>
                                            <a href="more-shop-product.html">Data Siswa</a>
                                        </li>
                                        <li>
                                            <a href="more-shop-product.html">Data Kelas</a>
                                        </li>
                                        <li>
                                            <a href="more-shop-product.html">Data Mengajar</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="forms-basic.html">Data Nilai Siswa</a>
                                </li>
                                <li>
                                    <a href="forms-extended.html">Data Kehadiran Siswa</a>
                                </li>
                                <li class='dropdown-submenu'>
                                    <a href="forms-extended.html">Data Administrasi Siswa &nbsp;  &nbsp; </a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="more-shop-list.html">Daftar Ulang</a>
                                        </li>
                                        <li>
                                            <a href="more-shop-product.html">SPP</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class='dropdown-submenu'>
                                    <a href="forms-extended.html">Laporan</a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="more-shop-list.html">Meshplace</a>
                                        </li>
                                        <li>
                                            <a href="more-shop-product.html">Nilai</a>
                                        </li>
                                        <li>
                                            <a href="more-shop-product.html">Kehadiran Siswa</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="forms-basic.html">Administrasi Data</a>
                                </li>
                                <li>
                                    <a href="forms-extended.html">User & Role Manajemen</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
