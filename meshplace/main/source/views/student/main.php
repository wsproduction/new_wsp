        ...
        <div class="box box-color box-bordered">
            ...
            <div class="box-content nopadding">
                <table id="main-grid" class="table table-hover table-bordered ws-grid" data-source="<?php echo $data_source; ?>">
                    <thead>
                        <tr>
                            <th field="nis" style="width: 100px;text-align: center;">NIS</th>
                            <th field="name" style="min-width: 100px;">Nama Lengkap</th>
                            <th field="gender" style="min-width: 50px;text-align: center;">Jenis Kelamin</th>
                            <th field="period" style="min-width: 50px;text-align: center;">Tahun Masuk</th>
